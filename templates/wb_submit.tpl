...
<tr>
<td width="100%"><span class="leftheader"><a href="<{$xoops_url}>"><{$smarty.const._MD_WB_HOME}></a> > <a href="<{$xoops_url}>/modules/<{$lang_moduledirname}>/index.php"><{$lang_modulename}></a> > <{$smarty.const._MD_WB_SUBMITART}></span></td></span></td>
<td width="100"><span class="rightheader"><{$lang_modulename}></span></td>
</tr>
</table>

<h3 class="cat"><{$send_def_to}></h3>
<p class='intro'><{$smarty.const._MD_WB_GOODDAY}><b><{$wb_user_name}></b>, <{$smarty.const._MD_WB_SUB_SNEWNAMEDESC}></p>
