    ...
    while ($myrow = $xoopsDB->fetchArray($result)) {
        ...
        if ($xoopsUser) {
            if ($xoopsUser->isAdmin()) {
                $adminlinks = "<a href=\"" . XOOPS_URL . "/modules/wordbook/admin/entry.php?op=mod&entryID=" . $entryID . "\" target=\"_blank\"><img src=\"" . XOOPS_URL . "/modules/wordbook/assets/images/edit.gif\" border=\"0\" alt=\"" . _MB_WB_EDITTERM . "\" width=\"15\" height=\"11\"></a>&nbsp;<a href=\"" . XOOPS_URL . "/modules/wordbook/admin/entry.php?op=del&entryID=" . $entryID . "\" target=\"_self\"><img src=\"" . XOOPS_URL . "/modules/wordbook/assets/images/delete.gif\" border=\"0\" alt=\"" . _MB_WB_DELTERM . "\" width=\"15\" height=\"11\"></a>&nbsp;";
            }
        }
        $userlinks = "<a href=\"" . XOOPS_URL . "/modules/wordbook/print.php?entryID=" . $entryID . "\" target=\"_blank\"><img src=\"" . XOOPS_URL . "/modules/wordbook/assets/images/print.gif\" border=\"0\" alt=\"" . _MB_WB_PRINTTERM . "\" width=\"15\" height=\"11\"></a>&nbsp;<a href=\"mailto:?subject=" . sprintf(_MB_WB_INTENTRY, $xoopsConfig["sitename"]) . "&amp;body=" . sprintf(_MB_WB_INTENTRYFOUND, $xoopsConfig['sitename']) . ":  " . XOOPS_URL . "/modules/wordbook/entry.php?entryID=" . $entryID . " \" target=\"_blank\"><img src=\"" . XOOPS_URL . "/modules/wordbook/assets/images/friend.gif\" border=\"0\" alt=\"" . _MB_WB_SENDTOFRIEND . "\" width=\"15\" height=\"11\"></a>&nbsp;";
