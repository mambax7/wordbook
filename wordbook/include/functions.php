...
function serviceLinks ( $variable )
	...
	if ( $xoopsUser ) 
		...
		if ( $xoopsUser->isAdmin() ) 
			{
			$srvlinks .= "<a href=\"admin/entry.php?op=mod&entryID=".$variable['id']."\" target=\"_blank\"><img src=\"images/edit.gif\" border=\"0\" alt=\""._MD_WB_EDITTERM."\" width=\"15\" height=\"11\"></a>&nbsp;<a href=\"admin/entry.php?op=del&entryID=".$variable['id']."\" target=\"_self\"><img src=\"images/delete.gif\" border=\"0\" alt=\""._MD_WB_DELTERM."\" width=\"15\" height=\"11\"></a>&nbsp;";
			}
		}
	$srvlinks .= "<a href=\"print.php?entryID=".$variable['id']."\" target=\"_blank\"><img src=\"images/print.gif\" border=\"0\" alt=\""._MD_WB_PRINTTERM."\" width=\"15\" height=\"11\"></a>&nbsp;<a href=\"mailto:?subject=".sprintf(_MD_WB_INTENTRY,$xoopsConfig["sitename"])."&amp;body=".sprintf(_MD_WB_INTENTRYFOUND, $xoopsConfig['sitename']).":  ".XOOPS_URL."/modules/".$xoopsModule->dirname()."/entry.php?entryID=".$variable['id']." \" target=\"_blank\"><img src=\"images/friend.gif\" border=\"0\" alt=\""._MD_WB_SENDTOFRIEND."\" width=\"15\" height=\"11\"></a>&nbsp;";
	return $srvlinks;
	}
