...
function DefinitionImport($delete)
{
    ...
    if (!$comentario) {
        ...
        echo "<p>Comments successfully moved from Dictionary to Wordbook</p>";
    }
...
function FormImport()
{
    ...
    echo "
    <tr>
      <td width='100%' colspan='2' align='center'><br><input type='submit' name='button' id='import' value='" . _AM_WB_IMPORT . "'>&nbsp;<input type='button' name='cancel' value='" . _CANCEL . "' onclick='history.go(-1);'></td>
    <tr>
    </TABLE>";
    CloseTable();
    xoops_cp_footer();
